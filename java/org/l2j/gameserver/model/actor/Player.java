...
import org.l2j.gameserver.ai.CreatureAI.IntentionCommand;
...
import org.l2j.gameserver.model.ChallengePoint;
...
import org.l2j.gameserver.model.RankingHistory;
...
import org.l2j.gameserver.model.actor.instance.TamedBeast;
...
import org.l2j.gameserver.model.actor.tasks.player.RentPetTask;
...
import org.l2j.gameserver.model.cubic.Cubic;
...
import org.l2j.gameserver.model.fishing.Fishing;
import org.l2j.gameserver.model.holders.AttendanceInfoHolder;
import org.l2j.gameserver.model.holders.AutoPlaySettingsHolder;
import org.l2j.gameserver.model.holders.AutoUseSettingsHolder;
import org.l2j.gameserver.model.holders.CollectionDataHolder;
import org.l2j.gameserver.model.holders.DamageTakenHolder;
import org.l2j.gameserver.model.holders.ElementalSpiritDataHolder;
import org.l2j.gameserver.model.holders.ItemHolder;
import org.l2j.gameserver.model.holders.ItemSkillHolder;
import org.l2j.gameserver.model.holders.MapHolder;
...
import org.l2j.gameserver.model.itemcontainer.PlayerRefund;
...
import org.l2j.gameserver.model.skill.AmmunitionSkillList;
...
import org.l2j.gameserver.network.serverpackets.ExBrPremiumState;
...
import org.l2j.gameserver.network.serverpackets.ExGetOnAirShip;
...
import org.l2j.gameserver.network.serverpackets.ExPledgeCoinInfo;
...
import org.l2j.gameserver.network.serverpackets.ExUserViewInfoParameter;
...
import org.l2j.gameserver.network.serverpackets.autopeel.ExReadyItemAutoPeel;
...
import org.l2j.gameserver.network.serverpackets.dualinventory.ExDualInventorySwap;
...
import org.l2j.gameserver.network.serverpackets.huntingzones.TimeRestrictFieldDieLimitTime;
...
import org.l2j.gameserver.network.serverpackets.surveillance.ExUserWatcherTargetStatus;
...
import org.l2j.gameserver.taskmanager.PlayerAutoSaveTaskManager;
...
public class Player extends Playable
{
	...
	{
		if (!teleportBookmarkCondition(1) || isInsideZone(ZoneId.TIMED_HUNTING))
		{
			return;
		}
