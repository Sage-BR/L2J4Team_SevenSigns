...
public class ArmorsetSkillHolder extends SkillHolder
{
	...
	public boolean validateConditions(Playable playable, ArmorSet armorSet, Function<Item, Integer> idProvider)
	{
		...
		if ((_artifactSlotMask > armorSet.getArtifactSlotMask(playable, _artifactBookSlot)) || (_minimumPieces > armorSet.getPieceCount(playable, idProvider)) || (_minEnchant > armorSet.getSetEnchant(playable)))
		{
			return false;
		}
